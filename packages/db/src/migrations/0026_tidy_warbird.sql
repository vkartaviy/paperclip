...
CREATE UNIQUE INDEX "offices_company_id_uniq" ON "offices" USING btree ("company_id");--> statement-breakpoint
CREATE UNIQUE INDEX "office_seats_office_agent_uniq" ON "office_seats" USING btree ("office_id","agent_id");--> statement-breakpoint
CREATE UNIQUE INDEX "office_seats_office_seat_uniq" ON "office_seats" USING btree ("office_id","seat_id");
